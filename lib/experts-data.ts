...
export const expertsData: Expert[] = [
  ...
  },
  {
    ...
    imageWithBackground: "/images/expert-jeon-hwan-ju-bg.png",
    education: ["- 중앙대학교 졸업\n- 2021년 한국공인회계사 시험 합격"],
    career: ["- (전) Deloitte 안진회계법인 감사본부\n- (전) 대주회계법인 5사업본부\n- (현) 모두세무회계그룹 대표회계사"],
    workAreas: [
      "[Audit&PA]\n- 제조, 건설, 도소매, IT 및 제약산업 회계감사\n- K사 등 연결재무제표 작성 및 별도재무제표 작성 관련 회계자문\n- H사 등 연결내부회계관리제도 및 별도내부회계관리제도 구축, 설계 및 운영평가 PA\n- 수주 및 건설업 진행매출 인식 관련 회계자문",
      "[TAX]\n- Y사, V사 등 세무조정 및 법인세 검토\n- B사 등 기장대리 및 세액공제, 감면 검토",
      "[FAS]\n- Y사 주식선택권 평가 및 검토\n- K사 영업권 평가 및 검토\n- M사 비상장주식 평가 및 검토",
    ],
  },
  {
    ...
    imageWithBackground: "/images/expert-yu-jae-il-bg.png",
    education: ["- 연세대학교 졸업\n- 2010년 한국공인회계사 시험 합격"],
    career: [
      "- (전) Deloitte 안진회계법인 세무자문본부\n- (전) 글로벌 테크기업 S사 한국법인 Finance Manager\n- (전) W홀딩스사 재무총괄\n- (현) 모두세무회계그룹 대표회계사\n- (현) 수원/화성/용인/판교 KICPA 지역투명성위원",
    ],
    workAreas: [
      "[TAX]\n- 세무기장/신고/조정 : 적정한 장부 작성 및 재무제표 산출로 대외 신뢰도를 높이고, 사업장 특성에 맞춘 최적의 세무 서비스를 제공합니다.\n- 재산세제 상담/신고 : 양도·상속·증여세 리스크를 사전 점검하고, 절세 관점의 맞춤 상담 및 신고를 진행합니다.\n- 비상장주식 가치평가 : 상속·증여 등 목적에 맞춘 주식 가치평가를 제공합니다.\n- 세무진단 : 세무조사 전 잠재적 리스크를 선제적으로 점검하여 맞춤형 절세 전략을 수립합니다.\n- 세무조사 : 풍부한 세무조사 대응 및 다양한 사업현장 경험을 바탕으로 정교하게 대응합니다.\n- 조세불복 : 부당한 과세 처분에 대해 정밀한 법리 검토로 이의신청·심판청구를 진행합니다.\n- 경정청구(세금환급) : 놓친 세제 혜택과 과오납된 세금을 다각적으로 검토해 환급을 진행합니다.",
