...
export const expertsData: Expert[] = [
  ...
  },
  {
    ...
    email: "modu123@naver.com",
    description:
      "정광화 회계사는 2018년 삼정회계법인 감사본부에 입사하여 전력인프라 및 제조업의 회계감사 및 회계자문용역을 수행하였으며, 삼도회계법인에서 회계감사, 재무실사 및 비상장주식가치 평가 등의 업무를 수행하였습니다. 다년간의 업무경험을 바탕으로 개별 기업에 특화된 전문 서비스를 제공합니다.",
