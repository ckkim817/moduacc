...
export const expertsData: Expert[] = [
  ...
  },
  {
    ...
    title: "회계사",
    tagline: "복잡한 회계 문제를 명확한 해답으로 풀어내는 전문가",
    email: "jychacpa@moduacc.com",
    description:
      "차재영 회계사는 안진회계법인 감사본부와 코스닥 상장사 회계팀장을 거치며, 회계 감사와 기업 결산 메커니즘을 완벽히 이해하고 있는 실무 전략가입니다. 감사인의 시각과 기업 현장의 고충을 모두 경험했기에, 단순한 숫자 검토를 넘어 복잡한 재무제표 작성과 결산체계를 구축하는 '최적화된 PA 솔루션'을 제시합니다.",
    image: "/images/expert-cha-jae-young.png",
    imageWithBackground: "/images/expert-cha-jae-young-bg.png",
    education: ["- 중앙대학교 졸업\n- 2019년 한국공인회계사 시험 합격"],
    career: ["- (전) Deloitte 안진회계법인 감사본부\n- (전) 코스닥상장 I사 회계팀장\n- (현) 모두세무회계그룹 대표회계사"],
    workAreas: [
      "[Audit & Assurance]\n- 제조업, 도소매업 회계감사\n- 벤처투자조합 및 인베스트먼트 등 투자금융사 회계감사\n- 은행, 보험, 저축은행 등 대형 금융기관 회계감사",
      "[PA (Private Accounting)]\n- 코스피/코스닥 상장사 재무제표 작성 및 결산 지원\n- 코스닥 상장사 회계팀장 역임: 월/분기/연말 결산 총괄 및 사업보고서 작성\n- 금융상품, 파생상품(CB, 주식매수선택권 등) 평가 및 복잡한 회계 이슈 자문\n- 외부감사인 대응 및 감사 자료(EUC, MRC) 수감 전략 수립",
      "[내부회계관리제도]\n- 상장사 내부회계관리제도 구축 및 고도화 지원\n- 상장사 기업 내부통제 프로세스 설계 및 효과성 평가",
      "[Consulting & FAS]\n- 국책은행 공급망안정화기금 재무회계 및 IFRS9 시스템 구축 컨설팅\n- 기업 회계 프로세스 고도화 및 관리회계 목적 영업손익 실적 추정 자문",
    ],
  },
]
