...
export default function CompanyPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section
        className="pb-[100px] bg-white max-[440px]:pb-8 pt-[190px] max-[440px]:!pt-[116px]"
      >
        <div
        ...
        >
          <div className="container mx-auto px-6 max-[440px]:px-0">
            <div className="max-w-7xl mx-auto text-center">
              ...
              <p
                className="max-[440px]:text-[16px] max-[440px]:leading-[24px] font-semibold text-2xl"
                style={{
                  marginBottom: "calc(100vw * 100 / 1920)",
                  color: "rgba(17, 17, 17, 0.5)",
                }}
              >
                국내 최고 수준의 회계사·세무사가 처음부터 끝까지 책임지고,
                <br />
          ...
          <div className="container mx-auto px-6 max-[440px]:px-0">
            <div className="max-w-7xl mx-auto space-y-16 max-[440px]:space-y-[60px]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-[440px]:gap-[10px] items-start">
                <h2 className="font-bold text-gray-900 max-[440px]:text-[20px] max-[440px]:leading-[25px] text-[30px] leading-[42px]">
                  처음부터 끝까지
                  <br />
                  함께하는 책임 파트너
                </h2>
                <p className="text-gray-600 max-[440px]:text-[16px] max-[440px]:leading-[24px] text-[22px] leading-[31px]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-[440px]:gap-[10px] items-start">
                ...
                <div>
                  <p className="text-gray-600 max-[440px]:text-[16px] max-[440px]:leading-[24px] text-[22px] leading-[31px] mb-5 max-[440px]:mb-[10px]">
