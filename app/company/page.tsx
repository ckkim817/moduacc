        ...
        >
          <div className="container mx-auto px-6 max-[440px]:px-0">
            <div className="max-w-7xl mx-auto text-center">
              <h1 className="font-bold text-[#111111] max-[440px]:text-[30px] max-[440px]:leading-[39px] text-[40px] leading-[56px] max-[440px]:mb-[10px] mb-[20px]">
                안정된 재무 관리로
                <br />
                내일의 도약을 준비합니다.
              </h1>
          ...
          <div className="container mx-auto px-6 max-[440px]:px-0">
            <div className="max-w-7xl mx-auto space-y-[50px] max-[440px]:space-y-[60px]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-[440px]:gap-[10px] items-start">
                <h2 className="font-bold text-[#111111] max-[440px]:text-[20px] max-[440px]:leading-[25px] text-[24px] leading-[33.6px]">
                  처음부터 끝까지
                  <br />
                  함께하는 책임 파트너
                </h2>
                <p className="text-[#535353] max-[440px]:text-[16px] max-[440px]:leading-[24px] text-[18px] leading-[25.2px]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-[440px]:gap-[10px] items-start">
                ...
                <div>
                  <p className="text-[#535353] max-[440px]:text-[16px] max-[440px]:leading-[24px] text-[18px] leading-[25.2px] mb-[10px] max-[440px]:mb-[10px]">
                  ...
                  <Link href="/experts" className="text-[#355CBA] inline-flex items-center gap-0.5 font-bold max-[440px]:text-[16px] text-[18px] min-[440px]:leading-[25.2px]">
                    전문가 소개
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-[440px]:gap-[10px] items-start">
                ...
                <div>
                  ...
                  <Link href="/services" className="text-[#355CBA] inline-flex items-center gap-0.5 font-bold max-[440px]:text-[16px] text-[18px] min-[440px]:leading-[25.2px]">
                    서비스 소개
                    <Image src="/images/design-mode/icon3.svg" alt="" width={20} height={20} className="inline-block" />
                  </Link>
                </div>
