...
export default function PrivacyPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white pt-[220px] max-[441px]:!pt-[116px]">
        ...
        >
          <div className="max-w-[1160px] mx-auto">
            {/* Title */}
            <h1 className="font-bold text-[40px] leading-[56px] mb-[110px] text-center max-[441px]:text-[30px] max-[441px]:leading-[39px] max-[441px]:mb-[60px]" style={{ color: "#111111" }}>
              개인정보 처리방침
            </h1>

            {/* Intro */}
            <p className="text-[18px] leading-[25.2px] font-normal mb-[40px] max-[441px]:text-[17px] max-[441px]:leading-[26px]" style={{ color: "#333333" }}>
            ...
            {/* Section 1 */}
            <h2 className="text-[20px] leading-[28px] font-bold mb-[12px] max-[441px]:text-[18px] max-[441px]:leading-[25px]" style={{ color: "#111111" }}>
              제 1 조 (개인정보의 수집 및 이용)
            </h2>
            <div className="text-[18px] leading-[25.2px] font-normal mb-[40px] max-[441px]:text-[17px] max-[441px]:leading-[26px]" style={{ color: "#333333" }}>
            ...
            <p className="text-[18px] leading-[25.2px] font-normal max-[441px]:text-[17px] max-[441px]:leading-[26px]" style={{ color: "#333333" }}>
      ...
      <div className="h-[300px] max-[441px]:h-[160px]" />
