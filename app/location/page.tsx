        ...
        >
          <div className="container mx-auto px-6 max-[440px]:px-0">
            <div className="max-w-7xl mx-auto">
              {/* Page Title */}
              <h1 className="font-bold text-[#111111] text-center max-[440px]:text-[30px] max-[440px]:leading-[39px] max-[440px]:mb-[60px] text-6xl leading-[80px] mb-[100px]">
                오시는 길
              </h1>
              ...
              <div className="mx-auto flex justify-start max-[440px]:justify-center" style={{ maxWidth: "1200px" }}>
                <Link
                  ...
                  className="inline-flex items-center justify-center rounded-full border-2 max-[440px]:border text-[#355CBA] border-[#355CBA] hover:bg-[#355CBA] hover:text-white transition-colors font-bold max-[440px]:w-[calc(100vw*335/375)] max-[440px]:px-6 max-[440px]:py-3 max-[440px]:gap-1 max-[440px]:text-[15px] max-[440px]:leading-[22px] px-[30px] py-[18px] gap-[6px] text-[20px]"
